                ...
                <div className='flex-1 flex justify-evenly items-center flex-col h-full'>
                    <div className='bg-white p-2 md:p-8 flex justify-center items-center flex-col rounded-3xl'>
                        ...
                        <div className='p-2 md:p-5 bg-[#3EC1D0] flex flex-col gap-3 rounded-2xl ms-2 mt-2 me-2 md:ms-5 md:me-5 md:mt-5'>
                            <h1 className='text-start text-xl  text-[#505050]  max-w-xs md:max-w-md'>An OTP has been sent to your registered email address</h1>
                            <div className='flex flex-col gap-1'>
                                <label htmlFor="email" className='text-[#505050]'>Enter OTP received on your email</label>
                                <input type="text" name="" id="" className=' p-2 rounded-md' placeholder='Enter OTP' />
                            </div>
                            <span className='text-[#1F6CAB] underline text-center'>Resend OTP</span>
                            <div className='text-center'>
                                <button className='bg-[#1F6CAB] w-40 p-2 text-white rounded-md'>SUBMIT</button>
                            </div>
                        </div>
