            ...
            <section className='h-screen flex justify-between items-center bg-[#E4FBFB] '>
                <div className='flex-1 flex justify-evenly items-center flex-col h-full'>
                    <div className='bg-white p-2 md:p-8 flex justify-center items-center flex-col rounded-3xl'>
                        ...
                        <div className='p-2 md:p-6 bg-[#3EC1D0] flex flex-col gap-3 rounded-2xl ms-2 mt-2 me-2 md:ms-5 md:me-5 md:mt-5'>
                            <h1 className='text-center text-xl text-[#1F6CAB]'>Reset Password</h1>
                            <div className='flex flex-col gap-1'>
                                <label htmlFor="email" className='text-[#505050]'>Email ID</label>
                                <input type="text" name="" id="" className='w-80 p-2 rounded-md' placeholder='Enter Your Registered email id' />
                            </div>
